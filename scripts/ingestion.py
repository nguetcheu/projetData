...
=======
csv_file_path = os.path.join(base_path, "Documents/projetData/data/climate_change_impact_on_agriculture_2024.csv")
>>>>>>> 84d37b5 (Normalisation des colonnes et journalisation des commandes via des logs)

# Charger les données CSV
df_static = spark.read.csv(csv_file_path, header=True, inferSchema=True)
